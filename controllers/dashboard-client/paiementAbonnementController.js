class PaiementAbonnementController {
    ...
    async create(req, res) {
        try {
            const newPaiementAbonnement = await this.service.createService(req);
            return res.status(201).json(newPaiementAbonnement);
        } catch (error) {
...
module.exports = PaiementAbonnementController;
